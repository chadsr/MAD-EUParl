...
DOWNLOAD_TIMEOUT = 30
DATA_URLS = {
    DIR_VOTES: "http://parltrack.euwiki.org/dumps/ep_votes.json.xz",
...
__EP__ = {PREFIX: EUROPEAN_PARLIAMENT, "dbpedia": EUROPEAN_PARLIAMENT_DBR}

__EC__ = {PREFIX: EUROPEAN_COMMISSION, "dbpedia": EUROPEAN_COMMISION_DBR}

__CSL__ = {PREFIX: EUROPEAN_COUNCIL, "dbpedia": EUROPEAN_COUNCIL_DBR}

__ESOC__ = {PREFIX: EUROPEAN_ECONOMIC_SOCIAL_COMMITTEE, "dbpedia": None}
...
__CJEC__ = {PREFIX: EUROPEAN_COMMUNITIES_COURT_OF_JUSTICE, "dbpedia": None}
...
__ECB__ = {PREFIX: EUROPEAN_CENTRAL_BANK, "dbpedia": EUROPEAN_CENTRAL_BANK_DBR}
